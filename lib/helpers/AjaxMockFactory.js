(function () {
            ...
            func = function (url, options) {
                ...
                if (response_info != null) {
                    ...
                    if (response_info.exception != null) {
                        try {
                            options.onFailure(response_info.exception);
                        } catch (e) {}
                    } else if (specific_callback in options) {
                        options[specific_callback](response_info);
    ...
    exports.ajaxMockFactory = ajaxMockFactory;
})();
