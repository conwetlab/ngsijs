...
(function () {
    ...
    describe("NGSI Library handles", function () {
        ...
        describe('getAvailableSubscriptions(options)', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.getAvailableSubscriptions().then(function (value) {
            ...
            it("basic request without details", function (done) {
                ...
                connection.getAvailableSubscriptions({details: false}).then(function (value) {
