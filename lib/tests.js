    ...
    describe("NGSI Library handles", function () {
        ...
        describe('deleteSubscription(subscriptionId[, callbacks])', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.deleteSubscription("57f7787a5f817988e4eb3dda").then(function (value) {
            ...
            it("basic request using old callbacks", function (done) {
                ...
                connection.deleteSubscription("57f7787a5f817988e4eb3dda", {
                    onSuccess: function () {
        ...
        describe('createEntity(entity[, options]', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.createEntity(entity).then(function (value) {
            ...
            it("basic request (using the flat option)", function (done) {
                ...
                connection.createEntity(entity_values, {flat: true}).then(function (value) {
                    expect(value).toEqual({
        ...
        describe('listEntities(options)', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.listEntities().then(function (value) {
            ...
            it("basic request", function (done) {
                ...
                connection.listEntities({keyValues: true}).then(function (value) {
                    expect(value).toEqual({results: [], count: 0, offset: 0});
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("basic request without details", function (done) {
                ...
                connection.listEntities({details: false}).then(function (value) {
        ...
        describe('listSubscriptions(options)', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.listSubscriptions().then(function (value) {
                    expect(value).toEqual({results: [], count: 0, offset: 0});
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("basic request without details", function (done) {
                ...
                connection.listSubscriptions({details: false}).then(function (value) {
                    expect(value).toEqual({results: []});
                    done();
                }, function (e) {
                    fail("Failure callback called");
