        ...
        runs(function () {
            ...
            ajaxMockup.addStaticURL("http://ngsi.server.com/ngsi10/updateContext", {
                    ...
                    checkRequestContent: function (url, options) {
                        ...
                        var contextAttrbuteElement = result.snapshotItem(0);
                        var nameElement = doc.evaluate('name', contextAttrbuteElement, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
                        var contextValueElement = doc.evaluate('contextValue', contextAttrbuteElement, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
                        if (NGSI.XML.getTextContent(nameElement) !== 'mobile_phone' || NGSI.XML.getTextContent(contextValueElement) !== '0034223456789') { return false; }
