...
describe("NGSI Library handles", function () {
    ...
    var connection, response, response_data, response_error_data, response_details, failure, ajaxMockup, eventsources, notification_data;
    ...
    it("basic query requests returnig structured attributes", function () {
    ...
    it("basic query requests returnig structured attributes and using the flat option", function () {
    ...
    it("basic update context requests with structured attributes", function () {
    ...
    it("basic add context requests with structured attributes", function () {
