...
/* globals ajaxMockFactory, mockedeventsources, EventSource, beforeEach, expect, fail, it, NGSI */
    ...
    describe("NGSI Library handles", function () {
                    ...
                    'attributes': [
                        {
                            'name': 'email',
                            'type': 'string',
                            'value': 'jacinto.salas@mycompany.com'
                        },
                        {
                            'name': 'function',
                            'type': 'string',
                        ...
                        "attributes": [
                            {
                                ...
                                "value": "2014-07-10T00:01:06+0200"
                            },
                            {
                                "name": "batteryCharge",
        ...
        describe('deleteEntity(options)', function () {
            ...
            it("deletes typed entities", function (done) {
                ...
                connection.v2.deleteEntity({id: "Spain-Road-A62", type: "Road"}).then(function (value) {
                    expect(value).toEqual(undefined);
                    done();
                }, function (e) {
                    fail("Failure callback called");
        ...
        describe('deleteSubscription(subscriptionId[, callbacks])', function () {
            ...
            it("basic request using old callbacks", function (done) {
                ajaxMockup.addStaticURL("http://ngsi.server.com/v2/subscriptions/57f7787a5f817988e4eb3dda", {
                    status: 204
                });

                connection.v2.deleteSubscription("57f7787a5f817988e4eb3dda", {
                    onSuccess: function () {
                        response_data = Array.prototype.slice.call(arguments);
                    },
                    onFailure: function (e) {
                        failure = e;
                    },
        ...
        describe('createEntity(entity[, options]', function () {
            ...
            it("basic request (using the flat option)", function (done) {
                ajaxMockup.addStaticURL("http://ngsi.server.com/v2/entities", {
                    status: 201,
                    headers: {
                        'Location': '/v2/entities/a?type=b'
                ...
                connection.v2.createEntity(entity_values, {flat: true}).then(function (value) {
                    expect(value).toEqual({
        ...
        describe('getEntity(options)', function () {
            ...
            it("basic get request", function (done) {
                ...
                connection.v2.getEntity("Spain-Road-A62").then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
                });
            ...
            it("retrieves typed entities", function (done) {
                ...
                connection.v2.getEntity({id: "Spain-Road-A62", type: "Road"}).then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("basic get request using the keyValues option", function (done) {
                ...
                connection.v2.getEntity({id: "Spain-Road-A62", keyValues: true}).then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
        ...
        describe('getEntityAttributes(options)', function () {
            ...
            it("allows basic usage only passing the id", function (done) {
                ...
                connection.v2.getEntityAttributes("Spain-Road-A62").then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("retrieves typed entities", function (done) {
                ...
                connection.v2.getEntityAttributes({id: "Spain-Road-A62", type: "Road"}).then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("basic get request using the keyValues option", function (done) {
                ...
                connection.v2.getEntityAttributes({id: "Spain-Road-A62", keyValues: true}).then(function (entity) {
                    expect(entity).toEqual(entity_data);
                    done();
                }, function (e) {
                    fail("Failure callback called");
        ...
        describe('listEntities(options)', function () {
            ...
            it("basic request", function (done) {
                ...
                connection.v2.listEntities().then(function (value) {
                    expect(value).toEqual({results: [], count: 0, offset: 0});
                    done();
                }, function (e) {
                    fail("Failure callback called");
                });
            ...
            it("basic request", function (done) {
                ...
                connection.v2.listEntities({keyValues: true}).then(function (value) {
                    expect(value).toEqual({results: [], count: 0, offset: 0});
                    done();
                }, function (e) {
                    fail("Failure callback called");
            ...
            it("basic request without details", function (done) {
                ajaxMockup.addStaticURL("http://ngsi.server.com/v2/entities", {
                    checkRequestContent: function (url, options) {
                        expect("options" in options.parameters).toBeFalsy();
                        return true;
                ...
                connection.v2.listEntities({details: false}).then(function (value) {
        ...
        describe('listSubscriptions(options)', function () {
            ...
            it("basic request without details", function (done) {
                ...
                connection.v2.listSubscriptions({details: false}).then(function (value) {
                    expect(value).toEqual({results: []});
                    done();
                }, function (e) {
                    fail("Failure callback called");
        ...
        describe('replaceEntity(entity, options)', function () {
            ...
            it("basic replace request using old callbacks", function (done) {
                ajaxMockup.addStaticURL("http://ngsi.server.com/v2/entities/Spain-Road-A62/attrs", {
                    status: 204
                });
