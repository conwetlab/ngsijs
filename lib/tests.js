...
(function () {
    ...
    describe("NGSI Library handles", function () {
        ...
        describe('updateAttributes(changes[, options])', function () {
        ...
        describe('listSubscriptions(options)', function () {
            ...
            it("basic request without details", function (done) {
                ...
                connection.v2.listSubscriptions({details: false}).then(function (result) {
                    expect(result).toEqual({
                        correlator: "correlatortoken",
                        results: []
                    });
        ...
        describe('replaceEntity(entity, options)', function () {
            ...
            it("basic replace request", function (done) {
                ...
                connection.v2.replaceEntity(entity_data).then(function (result) {
                    expect(result).toEqual({
                        correlator: "correlatortoken",
                        entity: entity_data
                    });
            ...
            it("basic replace request using the keyValues option", function (done) {
                ...
                connection.v2.replaceEntity(entity_data, {keyValues: true}).then(function (result) {
                    expect(result).toEqual({
                        correlator: "correlatortoken",
                        entity: entity_data
                    });
