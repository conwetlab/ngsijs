...
(function () {
    ...
    var makeJSONRequest = function makeJSONRequest(url, payload, parse_func, callbacks, parameters, method) {
    ...
    var parse_available_subscriptions_response = function parse_available_subscriptions_response(data, options) {
    ...
    var parse_delete_subscriptions_response = function parse_delete_subscriptions_response(data, options) {
        return [];
    };
    ...
    NGSI.Connection.prototype.getAvailableSubscriptions = function getAvailableSubscriptions(options) {
        ...
        var parameters = parse_pagination_options(options, undefined);
        return makeJSONRequest.call(this, url, null, parse_available_subscriptions_response, options, parameters);
    };

    NGSI.Connection.prototype.deleteSubscription = function deleteSubscription(subscriptionId, options) {
        var url = this.url + interpolate(NGSI.endpoints.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(subscriptionId)});
        return makeJSONRequest.call(this, url, null, parse_delete_subscriptions_response, options, null, "DELETE");
    };
