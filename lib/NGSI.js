...
(function () {
    ...
    NGSI.Connection.prototype.createEntity = function createEntity(entity, options) {
        ...
        var url = this.url + NGSI.endpoints.ENTITY_COLLECTION;
    ...
    NGSI.Connection.prototype.replaceEntity = function replaceEntity(entity, options) {
        ...
        var url = this.url + interpolate(NGSI.endpoints.ENTITY_ATTRS_ENTRY, {entityId: encodeURIComponent(entity.id)});
        var parameters = {};
    ...
    NGSI.Connection.prototype.getAvailableSubscriptions = function getAvailableSubscriptions(options) {
        ...
        var url = this.url + NGSI.endpoints.SUBSCRIPTION_COLLECTION;
        var parameters = parse_pagination_options(options, 'on');
    ...
    NGSI.Connection.prototype.deleteSubscription = function deleteSubscription(subscriptionId, callbacks) {
        ...
        var url = this.url + interpolate(NGSI.endpoints.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(subscriptionId)});
