...
(function () {
    ...
    NGSI.Connection.prototype.getAvailableSubscriptions = function getAvailableSubscriptions(options) {
        ...
        makeJSONRequest.call(this, url, null, parse_available_subscriptions_response, options, parameters);
    };

    NGSI.Connection.prototype.deleteSubscription = function deleteSubscription(subscriptionId, options) {
        var url = this.url + interpolate(NGSI.endpoints.SUBSCRIPTION_ENTRY, {subscriptionId: subscriptionId});
        makeJSONRequest.call(this, url, null, parse_delete_subscriptions_response, options, null, "DELETE");
    };
