...
(function () {
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#updateAttributes
     * @method
     *
     * @param {Object} changes
     * @param {Object} [options] Object with extra options:
     ...
     *
     * connection.v2.updateAttributes({
     *     "id": "sensor",
     *     "temperature": 31.5
     *     "humidity": 50.2
     * }, {
     ...
     *
     */
    NGSI.Connection.V2.prototype.updateAttributes = function updateAttributes(changes, options) {
        if (options == null) {
            options = {};
        }
