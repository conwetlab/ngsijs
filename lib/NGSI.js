...
(function () {
    ...
    var ngsi_build_entity_id_element_json = function ngsi_build_entity_id_element_json(entity) {
        entity.isPattern = entity.isPattern || false;
        return entity;
    };
            ...
            if (attributes != null) {
                ...
                for (j = 0; j < attributes.length; j += 1) {
                    ...
                    if ("value" in attribute) {
                        attributeElement.value = attribute.value;
                    }

                    if (Array.isArray(attribute.metadatas) && attribute.metadatas.length > 0) {
                        attributeElement.metadatas = ngsi_build_attribute_metadata_element(attribute.metadatas);
                    }
