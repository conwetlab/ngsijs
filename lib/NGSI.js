...
(function () {
     ...
     * @method
     *
     * @param {String|Object} options Object with extra options:
     * - `keyValues` (`Boolean`; default: `false`): Use flat attributes
     * @returns {Promise}
     *
     * @example <caption>Basic usage</caption>
     *
     * connection.getEntity("Spain-Road-A62").then((entity) => {
     ...
     * @example <caption>Basic usage</caption>
     *
     * connection.getEntityAttributes("Spain-Road-A62").then((entity) => {
     *     // Entity retrieved successfully
     * });
     *
     * @example <caption>Retrieve a typed entity and using the keyValues option</caption>
    ...
    NGSI.Connection.V2.prototype.getEntityAttributes = function getEntityAttributes(options) {
        ...
        var connection = privates.get(this);
        var url = connection.url + interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_ENTRY, {entityId: encodeURIComponent(options.id)});
        var parameters = {};
        if (options.type != null) {
            parameters.type = options.type;
        }
     ...
     *
     */
    NGSI.Connection.V2.prototype.replaceEntity = function replaceEntity(entity, options) {
        if (options == null) {
            options = {};
        }

        var connection = privates.get(this);
        var url = connection.url + interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_ENTRY, {entityId: encodeURIComponent(entity.id)});
        var parameters = {};
     ...
     *     String with the entity id to remove or object providing options
     * @returns {Promise}
     *
     ...
     * );
     */
    NGSI.Connection.V2.prototype.deleteSubscription = function deleteSubscription(subscriptionId, callbacks) {
        if (callbacks == null) {
            callbacks = {};
        }

        var connection = privates.get(this);
        var url = connection.url + interpolate(NGSI.endpoints.v2.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(subscriptionId)});
