...
(function () {
    ...
    NGSI.ProxyConnection = function ProxyConnection(url, makeRequest /* TODO */) {
        ...
        Object.defineProperties(this, {
            connected: {
                get: function () {
                    return privates.get(this).connected;
                }
            },
            connecting: {
                get: function () {
    ...
    NGSI.ProxyConnection.prototype.associateSubscriptionId = function associateSubscriptionId(callback_id, subscription_id) {
        var priv = privates.get(this);

        if (callback_id in priv.callbacks && priv.callbacks[callback_id].subscription_id === null) {
            priv.callbacks_by_subscriptionId[subscription_id] = priv.callbacks[callback_id];
            priv.callbacks[callback_id].subscription_id = subscription_id;
        }
    };
    ...
    NGSI.ProxyConnection.prototype.close_callback_by_subscriptionId = function close_callback_by_subscriptionId(subscription_id, onSuccess, onFailure) {
        if (subscription_id in this.callbacks_by_subscriptionId) {
            this.closeCallback(this.callbacks_by_subscriptionId[subscription_id].callback_id, onSuccess, onFailure);
        } else {
     ...
     */
    NGSI.ProxyConnection.prototype.purgeCallback = function purgeCallback(callback_id) {
        var priv = privates.get(this);
        if (callback_id in priv.callbacks) {
            if (priv.callbacks[callback_id].subscription_id != null) {
                delete priv.callbacks_by_subscriptionId[priv.callbacks[callback_id].subscription_id];
            }
            delete priv.callbacks[callback_id];
        }
    };
