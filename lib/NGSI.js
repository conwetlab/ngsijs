...
(function () {
    ...
    var parse_notify_context_request = function parse_notify_context_request(doc, options) {
        ...
        data.subscriptionId = NGSI.getTextContent(subscriptionIdElement);
        data.originator = NGSI.getTextContent(subscriptionIdElement);
    ...
    ProxyConnection.prototype.connect = function connect() {
    ...
    NGSI.Connection.prototype.createSubscription = function createSubscription(e, attr, duration, throttling, cond, callbacks) {
        ...
        this.ngsi_proxy.request_callback(callbacks.onNotify, function (proxy_callback) {
