...
(function () {
    ...
    NGSI.endpoints = {
        ...
        v2: {
            ENTITY_ATTRS_ENTRY: 'v2/entities/%(entityId)s/attrs',
    ...
    var makeJSONRequest2 = function makeJSONRequest2(url, options) {
        ...
        options.requestHeaders = JSON.parse(JSON.stringify(this.request_headers));
    ...
    var propagate_success_listeners = function propagate_success_listeners(callbacks, value) {
        return new Promise(function (resolve, reject) {
    ...
    var propagate_failure_listeners = function propagate_failure_listeners(callbacks, error) {
        return new Promise(function (resolve, reject) {
            if (typeof callbacks.onFailure === 'function') {
                callbacks.onFailure(error);
            }
    ...
    var ngsi_build_replace_entity_request = function ngsi_build_replace_entity_request(entity, options, parameters) {
        ...
        if (options.flat === true || options.keyValues === true) {
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#listEntities
     * @method
     *
     * @param {Object} [options] Object with extra options:
     * - `details` (`Boolean`; default: `true`): request pagination details
     ...
     *
     * connection.listEntities({offset: 20, details: true}).then(
     *     (response) => {
     *         // response.results is an array with the retrieved entities
     ...
     * );
     */
    NGSI.Connection.prototype.listEntities = function listEntities(options) {
        if (options == null) {
            options = {};
        }

        var url = this.url + NGSI.endpoints.v2.ENTITY_COLLECTION;
        var parameters = parse_pagination_options(options, 'on');
        var optionsparams = [];
        if (parameters.details === "on") {
        ...
        return makeJSONRequest2.call(this, url, {
            ...
            return new Promise(function (resolve, reject) {
                if (response.status !== 200) {
                    reject(new NGSI.InvalidResponseError('Unexpected error code: ' + response.status));
                }
            ...
            propagate_success_listeners.bind(null, options),
            propagate_failure_listeners.bind(null, options)
        );
    };
     ...
     * @method
     *
     * @param {Object} entity values to be used for creating the new entity
     * @param {Object} [options]
     * @returns {Promise}
     *
     * @example <caption>Basic usage</caption>
     ...
     * });
     *
     * @example <caption>Using the flat option</caption>
     *
     * connection.createEntity({
     *     "id": "Spain-Road-A62",
     *     "type": "Road",
     ...
     *
     */
    NGSI.Connection.prototype.createEntity = function createEntity(entity, options) {
        if (options == null) {
            options = {};
        }
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#replaceEntity
     * @method
     *
     * @param {Object} entity
     * @param {Object} [options] Object with extra options:
     * - `flat` (`Boolean`; default: `false`): Use flat attributes
     * @returns {Promise}
     *
     * @example <caption>Basic usage</caption>
     *
     * connection.replaceEntity({
     *     "id": "Spain-Road-A62",
     *     "type": "Road",
     *     "name": {"value": "A-62"},
     *     "alternateName": {"value": "E-80"},
     ...
     *
     */
    NGSI.Connection.prototype.replaceEntity = function replaceEntity(entity, options) {
        if (options == null) {
            options = {};
        }

        var url = this.url + interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_ENTRY, {entityId: encodeURIComponent(entity.id)});
        var parameters = {};
     ...
     * - `details` (`Boolean`; default: `true`): request pagination details
     * - `limit` (`Number`; default: `20`): This option allow you to specify the maximum
     *   number of subscriptions you want to receive from the server
     * - `offset` (`Number`; default: `0`): Allows you to skip a given number of elements
     *   at the beginning
     * @returns {Promise}
     *
     ...
     * @example <caption>Retrieve second page from the Context Broker requesting pagination details</caption>
     *
     * connection.listSubscriptions({offset: 20, details: true}).then(
     *     (response) => {
     *         // response.results is an array with the retrieved subscriptions
     ...
     *
     */
    NGSI.Connection.prototype.listSubscriptions = function listSubscriptions(options) {
        if (options == null) {
            options = {};
        }

        var url = this.url + NGSI.endpoints.v2.SUBSCRIPTION_COLLECTION;
        var parameters = parse_pagination_options(options, 'on');
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#deleteSubscription
     * @method
     *
     * @param {String} subscriptionId
     * @param {Object} [callbacks] Object with the callbacks to use (deprecated)
     * @returns {Promise}
     *
     * @example
     *
     * connection.deleteSubscription("57f7787a5f817988e4eb3dda").then(
     *     () => {
     ...
     * );
     */
    NGSI.Connection.prototype.deleteSubscription = function deleteSubscription(subscriptionId, callbacks) {
        if (callbacks == null) {
            callbacks = {};
        }

        var url = this.url + interpolate(NGSI.endpoints.v2.SUBSCRIPTION_ENTRY, {subscriptionId: encodeURIComponent(subscriptionId)});
        ...
        return makeJSONRequest2.call(this, url, {
            ...
            propagate_success_listeners.bind(null, callbacks),
            propagate_failure_listeners.bind(null, callbacks)
        );
    };
