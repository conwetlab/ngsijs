...
(function () {
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#getAvailableSubscriptions
     * @method
     *
     * @param {Object} [options] Object with extra options:
     ...
     * @example
     *
     * connection.getAvailableSubscriptions({offset: 20}).then(
     * );
     */
    NGSI.Connection.prototype.getAvailableSubscriptions = function getAvailableSubscriptions(options) {
        if (options == null) {
            options = {};
        }
