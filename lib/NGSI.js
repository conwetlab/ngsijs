...
(function () {
                ...
                function (response) {
                    if ([200, 201].indexOf(response.status) === -1) {
                        if (typeof onFailure === 'function') {
                            onFailure(new NGSI.InvalidResponseError('Unexpected error code: ' + response.status));
                        }
                        return;
                    }
     ...
     * @since 1.0
     *
     * @name NGSI.Connection#appendAttributes
     * @method
     *
     * @param {Object} options Object with extra options:
     ...
     * @example <caption>Basic usage</caption>
     *
     * connection.appendAttributes("Spain-Road-A62").then((entity) => {
     *     // Entity retrieved successfully
     * });
     *
     * @example <caption>Append or update the temperature attribute</caption>
     *
     * connection.v2.appendAttributes({
     *     "id": "Bcn-Welt",
     *     "temperature": {
     *         "value": 31.5
     *     }
     ...
     *
     */
    NGSI.Connection.V2.prototype.appendAttributes = function appendAttributes(changes, options) {
        if (options == null) {
            options = {};
        }

        var connection = privates.get(this);
        var url = connection.url + interpolate(NGSI.endpoints.v2.ENTITY_ATTRS_ENTRY, {entityId: encodeURIComponent(changes.id)});
        var parameters = {};
        var optionsparams = [];
